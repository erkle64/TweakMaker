...
namespace Narod
{
    namespace SteamGameFinder
    {
        public class SteamGameLocator
        {
            ...
            private readonly List<string> steamLibraryList = [];
            private readonly List<GameStruct> steamGameList = [];
            ...
            public GameStruct getGameInfoByFolder(string gameName)
            {
                ...
                GameStruct gameInfo = new()
                {
                    steamGameName = gameName,
                    steamGameID = "0" // not used
                };
