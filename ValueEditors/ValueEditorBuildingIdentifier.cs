...
{
    public class ValueEditorBuildingIdentifier : ValueEditor
    {
        ...
        public override void InitializeComponents(TableLayoutPanel table, int rowIndex)
        {
            ...
            _templateIdentifierControl = new(_dump.buildings.Values);
            ...
            _templateIdentifierControl.Name = $"BuildingIdentifier_{_labelText}";
