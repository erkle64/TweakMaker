...
{
    public class ValueEditorReservoirIdentifier : ValueEditor
    {
        ...
        public override void InitializeComponents(TableLayoutPanel table, int rowIndex)
        {
            ...
            _templateIdentifierControl = new(_dump.reservoirs.Values);
            ...
            _templateIdentifierControl.Name = $"ReservoirIdentifier_{_labelText}";
