...
{
    public class ValueEditorTerrainIdentifier : ValueEditor
    {
        ...
        public override void InitializeComponents(TableLayoutPanel table, int rowIndex)
        {
            ...
            _templateIdentifierControl = new(_dump.terrainBlocks.Values);
            ...
            _templateIdentifierControl.Name = $"TerrainIdentifier_{_labelText}";
