...
namespace TweakMaker
{
    public class DumpData
    {
        ...
        public string GetResearchName(string identifier)
        {
            if (researches.TryGetValue(identifier, out var research) && research.TryGetValue("name", out var name)) return name.ToString();
            return identifier;
        }
    }
}
